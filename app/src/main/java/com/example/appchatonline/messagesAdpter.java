...
import static com.example.appchatonline.chatwindo.reciverIImg;
import static com.example.appchatonline.chatwindo.senderImg;
                ...
                new AlertDialog.Builder(context).setTitle("Delete")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                messagesAdpterArrayList.remove(ITEM_SEND);


                                notifyItemRangeChanged(ITEM_SEND, messagesAdpterArrayList.size());
